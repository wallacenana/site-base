...
<footer class="footer">
    <div class="container footer-grid">
        <div class="footer-col">
            <a class="logo" href="<?php echo $base_path; ?>" style="margin-bottom:1.5rem;">
                ...
                Bla Bla <span class="text-primary">IPTV</span>
            </a>
            <p style="font-size:0.875rem; color:var(--muted-foreground); max-width: 250px; line-height: 1.6;">
                Entretenimento premium via streaming com qualidade incomparável, suporte dedicado e acesso em todos os
                dispositivos.</p>
        </div>
        <div class="footer-col">
            <h3>Navegação</h3>
        ...
        <div class="footer-col">
            ...
            <ul class="footer-links">
                ...
                <li><a href="https://blablachampanheria.com.br/whatsapp" target="_blank" class="footer-link">Suporte WhatsApp</a></li>
            </ul>
        </div>
        <div class="footer-col">
            <h3>Contato</h3>
            <p class="footer-desc">A melhor experiência de entretenimento digital. Milhares de canais, filmes e séries
                com Bla Bla IPTV.</p>
            <ul class="footer-links">
                <li>
                    <a href="tel:12997352409" class="footer-link">
                ...
                <li>
                    <a href="https://blablachampanheria.com.br/whatsapp" target="_blank" class="footer-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
    ...
    <div class="container copyright-area">
        <p>&copy; <?php echo date('Y'); ?> Bla Bla IPTV. Todos os direitos reservados.</p>
        <p>Serviço de streaming licenciado. Conteúdo sujeito à disponibilidade.</p>
    </div>
</footer>

<a href="https://blablachampanheria.com.br/whatsapp" target="_blank" class="float-wa">
